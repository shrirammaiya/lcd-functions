...
#define	LCD_LED(n) (n?HAL_GPIO_WritePin(TFT_LED_GPIO_Port,TFT_LED_Pin,GPIO_PIN_SET):HAL_GPIO_WritePin(TFT_LED_GPIO_Port,TFT_LED_Pin,GPIO_PIN_RESET)) //LCD����
#define LCD_CS(n)  (n?HAL_GPIO_WritePin(TFT_CS_GPIO_Port,TFT_CS_Pin,GPIO_PIN_SET):HAL_GPIO_WritePin(TFT_CS_GPIO_Port,TFT_CS_Pin,GPIO_PIN_RESET))
#define LCD_RS(n)  (n?HAL_GPIO_WritePin(TFT_DC_GPIO_Port,TFT_DC_Pin,GPIO_PIN_SET):HAL_GPIO_WritePin(TFT_DC_GPIO_Port,TFT_DC_Pin,GPIO_PIN_RESET))
